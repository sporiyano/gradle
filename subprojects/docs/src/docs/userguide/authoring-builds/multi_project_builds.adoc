...
====
include::sample[dir="snippets/multiproject/partialTasks/groovy",files="bluewhale/build.gradle[];krill/build.gradle[]"]
include::sample[dir="snippets/multiproject/partialTasks/kotlin",files="bluewhale/build.gradle.kts[];krill/build.gradle.kts[]"]
...
====
include::sample[dir="snippets/multiproject/dependencies-messagesHack/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];aProducer/build.gradle[]"]
include::sample[dir="snippets/multiproject/dependencies-messagesHack/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];aProducer/build.gradle.kts[]"]
...
====
include::sample[dir="snippets/multiproject/dependencies-webDist/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/multiproject/dependencies-webDist/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
We have the projects “`shared`”, “`api`” and “`person-service`”. The “`person-service`” project has a lib dependency on the other two projects. The “`api`” project has a lib dependency on the “`shared`” project.
...
[[javadependencies_2]]
====
include::sample[dir="snippets/multiproject/dependencies-java/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/multiproject/dependencies-java/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/multiproject/dependencies-javaWithCustomConf/groovy",files="build.gradle[]"]
include::sample[dir="snippets/multiproject/dependencies-javaWithCustomConf/kotlin",files="build.gradle.kts[]"]
====
